...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="<?= base_url('assets/templates/Admin/'); ?>plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?= base_url('assets/templates/Admin/'); ?>plugins/daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="<?= base_url('assets/templates/Admin/'); ?>plugins/datatables-bs4/css/dataTables.bootstrap4.css">
