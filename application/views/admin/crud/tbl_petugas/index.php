        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <a href="<?= base_url('Admin/Crud/Tbl_Petugas/add') ?>" class="btn btn-primary">Tambah Data</a>
            </div>
            <!-- /.card-header -->
              ...
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="<?= base_url('Admin/Crud/Tbl_Petugas/delete/').$p['id_petugas_monitoring'] ?>" onclick="return confirm('Yakin ?')" class="btn btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
